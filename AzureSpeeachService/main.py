...
COGNITIVESERVICES = "YOUR_COGNITIVE_SERVICES_RESOURCE_NAME"

NAME = "Simple transcription"
DESCRIPTION = "Simple transcription description"

LOCALE = "he-IL"
RECORDINGS_BLOB_URI = '<Your SAS Uri to a blob of audio file>'
...
def transcribe():
    ...
    configuration.host = COGNITIVESERVICES
    ...
    while not completed:
        ...
        if transcription.status == "Succeeded":
            ...
            for file_data in _paginate(api, pag_files):
                ...
                logging.info(f"Results for {audiofilename} {results.content.decode('utf-8')}")
