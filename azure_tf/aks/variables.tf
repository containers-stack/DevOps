...
variable "environment" {
  description = "(Required) Specifies the environment of the AKS cluster."
  type        = string
...
variable "gateway_subnet_id" {
  description = "(Optional) The ID of the Subnet where the Gateway should exist. Changing this forces a new resource to be created."
  type        = string
...
variable "image_cleaner_interval_hours" {
  description = "(Optional) Specifies the interval in hours for the Image Cleaner to run."
  type        = number
  default     = 24
}
...
variable "rg_id" {
  description = "(Required) The resource group id of the resource group where the AKS cluster will be deployed."
  type        = string
}

variable "node_resource_group" {
  description = "(Optional) The name of the resource group where the node pool should be deployed."
  type        = string
}

variable "secret_rotation_enabled" {
  description = "(Optional) Specifies whether secret rotation should be enabled."
  type        = bool
  default     = false
...
variable "shared_acr_id" {
  description = "(Required) The ID of the Azure Container Registry."
  type        = string
  
}

variable "node_pools" {
  description = "Specifies the node pools of the AKS cluster"
}

variable "core_vnet_rg" {
  description = "value of the core vnet resource group"
  type        = string
}

variable "core_vnet_id" {
  description = "value of the core vnet id"
  type        = string
}
variable "env_vnet_id" {
  description = "value of the environment vnet id"
  type        = string
}
